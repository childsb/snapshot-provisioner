...
import (
	...
	vol "github.com/childsb/snapshot-provisioner/ebs/pkg/volume"
)
...
var (
	...
	execCommand    = flag.String("execCommand", "/opt/storage/scripts/snap-provision.sh", "The provisioner executable.")
